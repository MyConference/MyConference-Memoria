...
La API, descrita en el capítulo \ref{chap:webservice}, es la columna vertebral de MyConference, y por tanto será la primera parte del proyecto que se instalará y configurará.
