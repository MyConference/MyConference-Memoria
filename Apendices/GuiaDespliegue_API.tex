...
%Para configurar qué base de datos utilizar, debemos establecer la variable \texttt{MONGO_URI} a una URI de tipo \texttt{mongodb:}, como por ejemplo \textt{mongodb://root:root@example.org/myconference}.
%También se aceptará este valor si se utiliza la variable \texttt{MONGOLAB_URI}, comose explicará en el punto \ref{sec:deploy-api-heroku}.
