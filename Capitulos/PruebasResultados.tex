...
\figura{Vectorial/Android/jornGerenciaAgenda}{width=0.5\textwidth,height=11cm}{fig:jornGerencias}%
	{Pantalla del prototipo para las Jornadas de Gerencia Universitaria}{Captura del prototipo}
...
En la figura ~\ref{fig:jornGerencias} se puede ver una captura de pantalla de la aplicación.
