...
\begin{description}
  ...
  \begin{description}
    ...
    \item[\texttt{type}] Tipo de documento. Sólo se admite \typett{link}.
  ...
  \begin{description}
    ...
    \item[\texttt{picture_url}] URL de la foto del ponente.
  \end{description}
...
\textit{TODO: Pendiente de completar}
...
\textit{TODO: Sección sin completar}
