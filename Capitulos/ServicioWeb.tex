...
\begin{description}
  ...
  Cada documento contiene un tipo de documento (únacamente pueden ser tipo \texttt{link}) y la URL a la que referencian, además de una descripción y un título.
