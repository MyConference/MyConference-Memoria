...
Posteriormente hablaremos del formulario web que permite a los usuarios introducir datos en el sistema.
Por último, hablaremos de la base de datos que almacena toda la información de MyConference.
